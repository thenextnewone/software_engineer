<template>
    <div class="app-container">
        ...
        <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
            ...
            <el-table-column align="center" prop="content" label="学号" style="width: 60px;"></el-table-column>
            <el-table-column align="center" label="姓名" width="170"></el-table-column>
